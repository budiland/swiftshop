        ...
        <div class="field-form">
            <div class="kiri">
                <form action="#" method="GET">
                    ...
                    <label for="nominal">Jumlah Uang yang akan dibayarkan</label>
                    <input type="text" name="nominal" id="nominal" placeholder="Masukkan nominal Uang">
            ...
            <div class="kanan php-muncul">
                <div class="atas">
                    <?php hasilForm($conn, "uang"); ?>
                    <canvas id="myChart" style="width:100%;"></canvas>
                    <!-- <img src="./img/Group 14.png" alt="" class="gambar"> -->
                    <p class="teks">Hasil Perhitungan akan muncul di sini</p>
                </div>
                <div class="bawah">
                    <a href="#" class="button-red">Download Excel</a>
                    <a href="#" class="button-green">Download PDF</a>
                </div>
            </div>
        </div>
    </div>
